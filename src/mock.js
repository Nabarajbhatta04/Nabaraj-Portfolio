...
export const projects = [
  {
    ...
    description: "A modern, responsive website for a hair salon featuring booking system, gallery, and service information. Built with React and modern UI components.",
  ...
  },
  {
    ...
    description: "A social platform for sharing and discovering memes. Features include user uploads, voting system, and real-time feed updates with smooth animations.",
    image: "/images/just_fungi.PNG",
    demoUrl: "#",
    githubUrl: "https://github.com/Nerrybhatt",
